...
import { CASE_CATEGORIES } from "@/constants/caseData";
...
export default function SelectPage() {
    ...
    const [selected, setSelected] = useState<SelectedCaseState>({
        category: CASE_CATEGORIES[0].name,
        case: CASE_CATEGORIES[0].details[0].name,
    });

    // 현재 선택된 대분류 찾기
    const currentCategory = CASE_CATEGORIES.find(
